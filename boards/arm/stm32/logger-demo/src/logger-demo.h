...
#ifdef CONFIG_CCLINK_CHANNEL_ONE
#define CCLINK_CHANNEL_ONE_TX   (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz |\
                                GPIO_OUTPUT_SET | CONFIG_CCLINK_CHANNEL_ONE_TX_PORT |CONFIG_CCLINK_CHANNEL_ONE_TX_PIN)
#endif /*CONFIG_CCLINK_CHANNEL_ONE*/


#ifdef CONFIG_CCLINK_CHANNEL_TWO
#define CCLINK_CHANNEL_TWO_TX   (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz |\
                                GPIO_OUTPUT_SET | CONFIG_CCLINK_CHANNEL_TWO_TX_PORT |CONFIG_CCLINK_CHANNEL_TWO_TX_PIN)
#endif /*CONFIG_CCLINK_CHANNEL_TWO*/


#ifdef CONFIG_CCLINK_CHANNEL_THREE
#define CCLINK_CHANNEL_THREE_TX (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz |\
                                GPIO_OUTPUT_SET | CONFIG_CCLINK_CHANNEL_THREE_TX_PORT |CONFIG_CCLINK_CHANNEL_THREE_TX_PIN)
#endif /*CONFIG_CCLINK_CHANNEL_TWO*/

#define CCLINK_RX_PIN       (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz |\
                            GPIO_OUTPUT_SET | CONFIG_CCLINK_RX_PIN |CONFIG_CCLINK_RX_PORT)
